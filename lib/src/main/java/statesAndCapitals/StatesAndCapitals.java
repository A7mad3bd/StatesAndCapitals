...
public class StatesAndCapitals {
    ...
    public void testStatesAndCapitals() throws IOException {
        ...
        StateInfo cardinalState = states.stream().filter(data -> data.getStateBird().equals("cardinal")).findFirst().orElseThrow();
        ...
        Boolean isAnyStateLessThan0Elevation = states.stream().anyMatch(data -> data.getLowestElevationInFeet() < 0);
        ...
        Boolean isAnyStateGreaterThan21000Elevation = states.stream().anyMatch(data -> data.getHighestElevationInFeet() > 21000);
        ...
        Boolean doAllStatesHaveAnAnthem = states.stream().allMatch(data -> data.getStateAnthem() != null);
        ...
        Boolean doNoStatesHaveAOneWordMotto = states.stream().noneMatch(data -> data.getStateMotto().split(" ").length==1);
        ...
        Double averageYearlyPrecipitationAcrossStateCapitals = states.stream().collect(averagingDouble(data -> data.getCapital().getAverageYearlyPrecipitationInInches()));
        ...
        Integer totalYearlyPrecipitationAcrossStateCapitals = states.stream().mapToInt(data -> data.getCapital().getAverageYearlyPrecipitationInInches()).sum();
        ...
        Map<String, Long> numberOfStatesByTimeZone =null;
                ...
                states.stream().collect(groupingBy(state -> state.getTimeZones()));
        ...
        Map<String, Long> numberOfStateCapitalsByTimeZone =null;
                states.stream().collect(groupingBy(data -> data.getCapital().getTimeZone()));
        ...
        List<String> stateTreesSortedAscending = states.stream().map(data -> data.getStateTree()).sorted().collect(toList());
        ...
        String allStateNamesSemicolonDelimited = states.stream().map(data -> data.getStateName()).collect(joining("; "));;
        ...
        List<String> allDistinctStateBirds = states.stream().map(data -> data.getStateBird()).distinct().collect(toList());
        ...
        List<String> allDistinctStateBirdsMinusMockingbirds = states.stream().filter(data -> !data.getStateBird().contains("mockingbird")).map(data ->data.getStateBird()).distinct().collect(toList());
        ...
        Long numberOfDistinctStateBirds = states.stream().map(data -> data.getStateBird()).distinct().count();
